    ...
    <div class="container ml-0 pl-0">
        <div class="login-box" style=" position: relative; right:-900px;">
            <div class="form-section">
                ...
                <form action="<?php echo site_url('reset');?>">
                  ...
                  <div style="text-align: center;">  <a href="#" id="regenerateOTP" class="text-dark " ></span> <span class="text-danger">RESEND OTP</span></a> <br>
                    <!-- <button id="regenerateOTP"  class="btn btn-warning btn_shadow" style="border-radius: 10;" >Resend OTP </button> -->
                     <span id="timer">01:00 </span> </div>
